...
def generate_roadmap (selected_job):
    ai_prompt = ( 
        f"Act as a professional, encouraging career counselor." 
        ...
        f"Break your response into sections: "
        f"Intro: (a short, motivating introduction, 2-3 sentences, explaining why "
        f"{selected_job} could be a great fit for this user), "
        f"then Phase 1, Phase 2, Phase 3, etc."
        f"Each phase should have a short title and details"
        f"Format it so each phase starts with 'Intro: or 'Phase X: [title]'."
